            ...
            <div className="main-left-side">
                <div className="row">
                    <div className="video-box">
                        ...
                        <div className="name-box-set" >Asmitha Sathya</div>
                    </div>
                    <div className="video-box">
                        <img src="/julia.jpg" alt="Julia Alumbro" className="video-thumbnail" />
                        <div className="name-box-set" >Julia Alumbro</div>
                    </div>
                    <div className="video-box">
                        <img src="/john.jpg" alt="John Doe" className="video-thumbnail" />
                        <div className="name-box-set" >John Doe</div>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="video-box">
                        ...
                        <div className="name-box-set" >Mary Smith</div>
                    </div>
                    <div className="video-box">
                        <img src="/shaili.jpg" alt="Shaili Tripathi" className="video-thumbnail" />
                        <div className="name-box-set" >Shaili Tripathi</div>
                    </div>
                    <div className="video-box">
                        <img src="/calvin.jpg" alt="Calvin Klein" className="video-thumbnail" />
                        <div className="name-box-set" >Calvin Klein</div>
                    </div>
                </div> 
